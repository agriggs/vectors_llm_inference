...
good_reviews_analysis = client.models.generate_content(
    model=model,
...
print(f"Gemini generated summary with {model} of good reviews: ")
print(good_reviews_analysis.text)
print("###########################################")
...
poor_review_analysis = client.models.generate_content(
     model=model,
    contents=context.format(reviews_str),
    config=types.GenerateContentConfig(
        system_instruction=question,
...
print(f"Gemini generated summary with {model} of the single worst review: ")
print(poor_review_analysis.text)
print("###########################################")
